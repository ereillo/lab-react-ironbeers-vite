  ...
  <h1>Add a New Beer</h1>
      <form>
       ...
       <br />
        ...
        <label>Tagline</label>
        <input type="text" name="tagline" value={tagline} onChange={handTaglineChange} />
        ...
        <input type="text" name="brewers_tips" value={brewersTips} onChange={handleBrewerTipsChange} />

        <br />

        <label>Attenuation Level</label>
        <input type="number" name="attenuation_level" value={attentuation} onChange={handleAttentuationChange} />

        <br />

        <label>Contributed By</label>
        <input type="text" name="contributed_by" value={contributed} onChange={handleContributedChange} />
